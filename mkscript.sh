...
_select_title(){
    ...
    # Convert the spaces from the title to underscore if necessary.
    title=${title// /_}
...
echo "## Define CONSTANT here " >> $title
echo "## Define functions here " >> $title
echo "## Main function from here " >> $title
echo "## Expected results \( if have \) " >> $title
